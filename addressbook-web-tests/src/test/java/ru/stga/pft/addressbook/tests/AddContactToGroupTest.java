    ...
    public class AddContactToGroupTest extends TestBase {
        ...
        public void ensurePreconditions() {
            ...
            if (app.contact().all().isEmpty()) {
                app.contact().create(new ContactData()
                        ...
                        .withEmail1("test@test").withEmail2("test1@test").withEmail3("test1@test"));
            }
        }
        @Test
        public void testAddContactToGroup() {
            ...
            if (app.db().contactNotInGroup().isEmpty()) {
                ...
                Contacts contacts = app.db().contactNotInGroup();
                app.goTo().goToPage();
                ...
                GroupData group = app.db().getNewGroup();
                System.out.println(modifiedContact.getId() + " " + group.getId());
